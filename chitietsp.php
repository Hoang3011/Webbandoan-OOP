...
<body>
  ...
  $sql = "SELECT sp.MA_SP, sp.TEN_SP, sp.HINH_ANH, sp.GIA_CA, sp.MO_TA,
               sp.MA_LOAISP, lsp.TEN_LOAISP, sp.TINH_TRANG
        FROM sanpham sp
        LEFT JOIN loaisp lsp ON sp.MA_LOAISP = lsp.MA_LOAISP
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xl-5 col-lg-5">
              <div class="inner-image">
                <div class="inner-img">
                  <img src="<?php echo htmlspecialchars($monAn->getHinhAnh()); ?>"
                    alt="<?php echo htmlspecialchars($monAn->getTen()); ?>" />
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-7 col-lg-7">
              <div class="inner-content">
                <div class="inner-ten"><?php echo htmlspecialchars($monAn->getTen()); ?></div>

                <div class="inner-tt">
                  Trạng thái:
                  <span class="inner-conhang">
                    <i class="fa-solid fa-check"></i>
                    <?php echo $monAn->getTinhTrang() == 1 ? "Còn món" : "Tạm ngừng"; ?>
                  </span>
                </div>

                <div class="inner-gia">
                  <?php echo number_format($monAn->getGiaCa(), 0, ',', '.'); ?>₫
                </div>

                <div class="inner-desc">
                  <?php echo nl2br(htmlspecialchars($monAn->getMoTa())); ?>
                </div>
              </div>
              ...
              <div class="inner-add">
                ...
                <div class="inner-tanggiam">
                  ...
                  <input id="tanggiam" type="text" value="1" class="inner-so" />
            ...
            <div class="col-xl-12">
              <div class="inner-thongtin">
                ...
                <div class="inner-mota">
                  <div class="inner-nd"><?php echo nl2br(htmlspecialchars($monAn->getMoTa())); ?></div>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-3">
          ...
          $sql_noibat = "SELECT MA_SP, TEN_SP, HINH_ANH, GIA_CA 
                       FROM sanpham WHERE TINH_TRANG = 1 ORDER BY RAND() LIMIT 4";
